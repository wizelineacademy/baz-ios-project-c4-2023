...
/**
A protocol for making objects searchable with a query string.
*/
protocol SearchableProtocol {
    /*
    Search for objects matching a given query.
     - Parameters:
     - query: A query string used to search for objects.
     - completion: A closure that will be called once the search is complete.
    */
    func search(query: String, completion: @escaping () -> ())
}

/**
A view model for searching and displaying a list of movies.
*/
...
/**
SearchViewModel extension conforming to the SearchableProtocol protocol.
*/
