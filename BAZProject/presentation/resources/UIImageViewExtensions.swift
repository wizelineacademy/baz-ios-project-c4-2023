...
extension UIImageView {
    ...
    /**
     ...
     - Parameter from: un parámetro de tipo URL que indica la URL de la imagen que se va a descargar y cargar en el objeto UIImageView.
     - Parameter placeHolder: un parámetro de tipo UIImage que se usara en caso de que la URL proporcionada sea erronea o no encuentre la imagen.
     - Parameter completion: un parámetro opcional de tipo (() -> Void)? que representa un bloque de código que se ejecutará después de que se complete la descarga de la imagen. Este bloque no devuelve ningún valor y no toma ningún parámetro.
     */
